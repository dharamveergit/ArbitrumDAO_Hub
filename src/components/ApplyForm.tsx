        ...
        {success ? (
          <div className="flex flex-col items-center justify-center gap-6 p-6">
            ...
            >
              ...
              Arbitrum CMS. This process may take a few days. You will receive
              an email notification with the outcome of your request or any
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-6">
                    ...
                    <label
                      className={titleCva({ size: "xs", className: "w-14" })}
                    >
                      Twitter
                    </label>
                    <input
