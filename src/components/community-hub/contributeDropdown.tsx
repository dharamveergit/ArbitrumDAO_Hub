...
const defaultData = [
  ...
  },
  {
    ...
    description: "Commit the added or updated content to your branch.",
  },
  {
    title: "Push Changes",
    description: "Push the changes to your forked repository on GitHub.",
  },
  {
  ...
  },
  {
    ...
    description: "Review the changes and make any necessary adjustments.",
  },
  {
...
const ContributionDropdown = ({
  ...
  titleSize = "md",
  description = "Are you eager to impart your insights and knowledge to the vibrant community? Explore this comprehensive guide on how you can actively contribute to this dynamic and evolving space.",
  data = defaultData,
  className,
  open = true,
}: {
  title?: string | React.ReactNode;
  titleSize?: "xl" | "lg" | "md" | "sm" | "xs";
  description?: React.ReactNode;
  data?: { title: string; description: string | React.ReactNode }[];
  className?: string;
  open?: boolean;
}) => {
  return (
    <section
      className={clsx("flex flex-col gap-2  py-5 md:gap-4 md:py-10", className)}
    >
      <h1
        className={titleCva({
          size: titleSize,
      ...
      <Accordion collapsible={open} type="single" className="w-full ">
